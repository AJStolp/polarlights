      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-gray-500 text-lg max-w-2xl mx-auto">
            Ready to start your project? Drop us a message and we&apos;ll get
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-500 leading-relaxed">
                  Based in Wisconsin, serving communities across Wisconsin and
                  Michigan&apos;s Upper Peninsula. Available for travel beyond
                  our core area for the right project.
                </p>
              </div>
            </div>
          </div>
